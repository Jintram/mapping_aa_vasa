...
mappingfolder=/hpc/hub_oudenaarden/mwehrens/fastq/202308_HFTFs_mapping/pLVX-IRES-Hyg/
...
gtffile=/hpc/hub_oudenaarden/mwehrens/ref/custom/pLVX-IRES-Hyg/pLVX-IRES-Hyg.gtf
  # only protein_coding, lincRNA, antisense (like cell ranger)
