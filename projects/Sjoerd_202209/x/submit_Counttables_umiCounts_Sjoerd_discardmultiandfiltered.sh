...
cd /hpc/hub_oudenaarden/mwehrens/fastq/WANG4/mapping/
...
do
  ...
  # some special cases
  if [[ "$lib" =~ (p.N14.plate.104720.part.1_cat|p.N14.plate.104720.part.2_cat|p.N1.plate.97474.part.2_cat) ]]; then
    mem="128G"
    echo "INCREASED MEM SETTING FOR $lib"
  fi  
