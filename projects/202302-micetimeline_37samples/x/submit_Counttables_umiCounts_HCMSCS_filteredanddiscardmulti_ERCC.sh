...
mappingfolder=/hpc/hub_oudenaarden/mwehrens/fastq/202302_micetimeline_37samples/mapping/
...
s1=Martijn-Wehrens-sample1_AACGFYKM5_S2
s2=Martijn-Wehrens-sample2_AACGFYKM5_S3
for lib in ${s1}_L001_nc ${s1}_L001_pT ${s2}_L001_nc ${s2}_L001_pT
do
  echo $lib
