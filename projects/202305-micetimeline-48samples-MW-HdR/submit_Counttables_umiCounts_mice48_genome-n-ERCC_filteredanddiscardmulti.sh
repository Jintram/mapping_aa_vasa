...
mappingfolder=/hpc/hub_oudenaarden/mwehrens/fastq/202305_micetimeline_48samples-MW-HdR/mapping/
...
s1=Sample-Hesther-de-Ruiter_AACLJ2GM5_S18
# s2=Martijn-Wehrens-sample2_AACGFYKM5_S3
for sample in $s1
do
  #sample=$s1
  for lib in ${sample}_L001_nc ${sample}_L001_pT 
  do
    echo $lib
