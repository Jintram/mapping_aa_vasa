...
then
    ${pythonbin} ${path2scripts}/TS_concatenator.py --fqf ${lib} --cbcfile ${path2scripts}/bc_celseq2.tsv --cbchd 0 --lenumi 6 --umifirst --TTTfilter --outdir ${outdir} $TS_str
    $exitcode = $?
...
then
    ...
    ${pythonbin} ${path2scripts}/TS_concatenator.py --fqf ${lib} --cbcfile ${path2scripts}/bc_takara_map_tcr_v1.tsv --cbchd 0 --lenumi 14 --lencbc 11 --outdir ${outdir} $TS_str
    $exitcode = $?
