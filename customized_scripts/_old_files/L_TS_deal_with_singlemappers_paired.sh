...
# what happens if we do this for the paired bed file?
...
then
    #cat ${inbam%.bam}.f2.singlemappers.intersect.bed | awk $awk_command_singlemappers_nonstranded > ${inbam%.bam}.singlemappers_genes.bed
    
    cat ${inbam%.bam}.f2.singlemappers.R1.intersect.bed | awk $awk_command_singlemappers_nonstranded > ${inbam%.bam}.R1.singlemappers_genes.bed
    cat ${inbam%.bam}.f2.singlemappers.R2.intersect.bed | awk $awk_command_singlemappers_nonstranded > ${inbam%.bam}.R2.singlemappers_genes.bed
fi
